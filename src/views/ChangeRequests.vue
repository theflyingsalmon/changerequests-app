...
export default {
  ...
  methods: {
    async fetchChangeRequests() {
      try {
        const response = await axios.get('https://changerequests-api-fsbnhbb3gbccfbgw.ukwest-01.azurewebsites.net/api/ChangeRequests');
    ...
    async createRequest(request) {
      try {
        await axios.post('https://changerequests-api-fsbnhbb3gbccfbgw.ukwest-01.azurewebsites.net/api/ChangeRequests', request);
      } catch (error) {
    ...
    async deleteRequest(id) {
      try {
        await axios.delete(`https://changerequests-api-fsbnhbb3gbccfbgw.ukwest-01.azurewebsites.net/api/ChangeRequests/${id}`);
        this.fetchChangeRequests();
      } catch (error) {
